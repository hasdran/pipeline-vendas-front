    ...
    <div class="collapse navbar-collapse menu" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <!-- <li class="nav-item dropdown">
              <div class="dropdown" title="Fechamento">
                <button class="btn dropdown-toggle" style="color: white" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                  <button class="dropdown-item" type="button">Acessar</button>
                  <button class="dropdown-item" type="button">Cancelar</button>
                  <button class="dropdown-item" type="button">Relatório</button>
                </div>
              </div>
            </li> -->
