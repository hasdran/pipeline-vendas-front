 ...
 <table class="table-sm">
    ...
    <tbody>
      ...
      @foreach($pipeline as $result)
         ...
         <tr>
          <td><input id='inpt_lin<?= $lin?>_col1' class="cli input_lst" type="text" value="<?= $result->CLIENTE ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col2' class="prj input_lst" type="text" value="<?= $result->PROJETO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col3' class="val input_lst" type="text" value="<?= $result->VALOR ?> "></td>
          <td><input id='inpt_lin<?= $lin?>_col4' class="vol input_lst" type="text" value="<?= $result->VOLUME ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col5' class="dt_ab input_lst" type="text" value="<?= $result->DT_ABERTURA ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col6' class="dt_ini input_lst" type="text" value="<?= $result->DT_INICIO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col7' class="prz input_lst" type="text" value="<?= $result->PRAZO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col8' class="prob input_lst" type="text" value="<?= $result->PROBAB ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col9' class="sit input_lst" type="text" value="<?= $result->ID_SITUACAO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col10' class="dt_enc input_lst" type="text" value="<?= $result->DT_ENCERR ?>"></td>          
          <td><input id='inpt_lin<?= $lin?>_col12' class="tmpo input_lst" type="text" value="<?= $result->TEMPO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col11' class="rec_est input_lst" type="text" value="<?= $result->REC_ESTIMADA ?>"></td>          
          <td><input id='inpt_lin<?= $lin?>_col13' class="rec_esp input_lst" type="text" value="<?= $result->REC_ESPERADA ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col14' class="impcto input_lst" type="text" value="<?= $result->IMPACTO ?>"></td>
          <td><input id='inpt_lin<?= $lin?>_col15' class="dur input_lst" type="text" value="Curto prazo"></td> 
          <td><input id='inpt_lin<?= $lin?>_col16' class="mud input_lst" type="text" value="<?= $result->MUDANCA_STS ?>"></td> 
        </tr>      
        @php
          $lin++;
        @endphp   
      ...
      @if(isset($op) and $op == "create")
        ...
        @csrf
          <tr>            
            ...
            <td>
              <!-- <input id="teste" class="form-control" type="text" name="situacao"> -->
              <select class="form-control" id="teste" name="situacao">
